...
public class CustomerController {
    ...
    @Autowired
    private CustomerService customerService;                //Injected new object-Dependency Injection
    ...
    public String updateCustomer(@RequestBody CustomerUpdateDTO customerUpdateDTO){
        String message= customerService.updateCustomer(customerUpdateDTO);                    // we used string message to catch Customer ServiceIMPL message.
        return message;
    }
